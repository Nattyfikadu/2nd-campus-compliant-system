...
const statusConfig = {
  pending: { label: 'Pending Review', icon: Clock, color: 'bg-yellow-100 text-yellow-700 border-yellow-200' },
  approved: { label: 'Approved', icon: CheckCircle2, color: 'bg-blue-100 text-blue-700 border-blue-200' },
  'in-progress': { label: 'In Progress', icon: Loader2, color: 'bg-purple-100 text-purple-700 border-purple-200' },
  ...
  return (
    <>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Withdraw Complaint</DialogTitle>
            <DialogDescription>
              Are you sure you want to withdraw <span className="font-medium">"{complaint.title}"</span>?
