        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-semibold text-base text-gray-900 tracking-tight">Campus Service Complaint System</h1>
                <p className="text-xs text-gray-500 font-mono tracking-wide">CSCS — Issue Management Portal</p>
              </div>
            </div>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  <DropdownMenuLabel>
                    <div className="flex flex-col space-y-1">
                      <p className="text-sm font-medium text-gray-900">{getUserDisplayName()}</p>
                      <p className="text-xs text-gray-500">{user.email}</p>
                      <span className={`text-xs px-2 py-1 rounded-full w-fit capitalize border border-gray-200 mt-1 ${getRoleBadgeColor(user.role)}`}>
                        {user.role}
                      </span>
                    </div>
                  </DropdownMenuLabel>
